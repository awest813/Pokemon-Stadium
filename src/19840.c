...
Fragment* LoadJPEG(MemoryBlock* arg0, PRESJPEG* arg1, PRESJPEG* arg2) {
    Fragment* sp1C;
    s32 sp18;
    s32 temp_v0_2;

    sp18 = arg0->size;
    sp1C = MainPoolState_AllocLinear(arg0, arg2->unk_0C + 0x100, 0x10);

    if (sp1C != NULL) {
        temp_v0_2 = JPEG_Decompress(sp1C, arg2->unk_0C + 0x100, (u8*)arg2 + arg2->unk_08);
        if (temp_v0_2 == 0) {
...
Fragment* LoadSZP(MainPoolState* arg0, PERSSZP* arg1, PERSSZP* arg2) {
    u8* sp1C = MainPoolState_AllocLinear(arg0, arg2->decompressed_size2, 0x10);

    if (sp1C != NULL) {
        SZP_Decompress(arg2, sp1C);
    }
    return sp1C;
}
...
Fragment* LoadRaw(MainPoolState* arg0, PERSSZP* arg1, s32 arg2, u32 arg3) {
    ...
    sp1C = MainPoolState_AllocLinear(arg0, arg3, 0x10);
    if (sp1C != NULL) {
...
Fragment* Archive_LoadFile_Internal(MainPoolState* arg0, s32 start, s32 end, PERSSZP* arg3, s32 arg4) {
    ...
    if (arg4 >= size) {
        ROM_LoadDirect(arg3, start, end, 0);
        ...
        if (((u32*)arg3->magic)[0] == 'PERS' && (((u32*)arg3->magic)[1] == '-SZP')) {
            ...
            var_v1 = LoadJPEG(arg0, arg3, arg3);
        } else {
...
Fragment* func_80018FF4(MainPoolState* arg0, unk_func_800041C0* arg1, PERSSZP* arg2, u32 arg3) {
    ...
    if (arg3 >= sp3C) {
        ...
        if (((u32*)temp_s1->magic)[0] == 'PERS' && (((u32*)temp_s1->magic)[1] == '-SZP')) {
            ...
            sp38 = LoadJPEG(arg0, arg2, temp_s1);
        } else {
...
Fragment* Archive_GetFragment(MainPoolState* arg0, BinArchive* arg1, s32 arg2, u32 arg3, s32 arg4) {
    s32 pad[4];
...
void func_80019484(unk_func_80019600* arg0) {
    ...
    sp28 = MainPoolState_Init(arg0->pool, arg0->size);
    sp24 = Archive_GetFragment(sp28, D_800ABE10.unk_A04.unk_00, arg0->unk_02, D_800ABE10.unk_A04.unk_08, 0x28000);
...
void func_80019514(unk_func_80019600* arg0) {
    ...
    temp_s6 = arg0->unk_08;
    var_s2 = 0;
    temp_s3 = MainPoolState_Init(arg0->pool, arg0->size);
    var_s0 = arg0->unk_0C;

    while (*var_s0 != -1) {
        temp_v0 = Archive_GetFragment(temp_s3, D_800ABE10.unk_A04.unk_04, *var_s0, D_800ABE10.unk_A04.unk_08, 0x28000);
        if (temp_v0 == NULL) {
            break;
        }
...
void func_8001987C(void) {
    D_800ABE10.unk_A04.unk_00 = Archive_ROM_Load(0x920000, NULL, 1, 1);
    D_800ABE10.unk_A04.unk_04 = Archive_ROM_Load(0x8CC000, NULL, 1, 1);
...
unk_D_86002F30* func_80019D18(s32 arg0) {
    ...
    sp2C = Archive_GetFile(D_800ABE10.unk_A04.unk_00, arg0 - 1);
    if (sp2C != NULL) {
        sp20 = func_80002D10(main_pool_get_available(), 0);
        sp28.raw = 0;
        sp24 = func_80019328(sp20, sp2C, sp28);
        MainPool_FreeWithResize(sp20);
    }
...
unk_D_86002F30* func_80019D90(unk_func_80026268_arg0* arg0) {
    ...
    sp2C = Archive_GetFile(D_800ABE10.unk_A04.unk_00, arg0->unk_00.unk_00 - 1);
    if (sp2C != NULL) {
        sp20 = func_80002D10(main_pool_get_available(), 0);
...
arg1_func_80019420* func_80019EA0(s32 arg0) {
    ...
    sp20 = NULL;
    sp24 = Archive_GetFile(D_800ABE10.unk_A04.unk_04, arg0);
    if (sp24 != NULL) {
        sp1C = func_80002D10(main_pool_get_available(), 0);
        sp20 = sp24->data;
        func_80019420(sp1C, sp20);
        MainPool_FreeWithResize(sp1C);
    }
    return sp20;
}
