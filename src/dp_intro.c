...
extern struct DisplayCtx D_80083CA0;

extern RSPTask D_800846C0;

extern struct FrameConfig D_8008472C;
extern struct FrameConfig D_8008473C;
extern struct FrameConfig D_8008474C;
...
extern void DisplayThread_Main(void*);
...
void Display_ProcessFrame(void) {
    ...
    if (D_80083CA0.unk_AA8 != NULL) {
        ...
        if ((D_80083CA0.unk_A9D != D_80083CA0.unk_AAD) || (D_80083CA0.unk_A9E != D_80083CA0.unk_AAE)) {
            VI_SetMode((s8)D_80083CA0.unk_A9D, (s8)D_80083CA0.unk_A9E);
        }
        if (D_80068B70 != 0) {
            osViBlack(1U);
        } else {
    ...
    if ((sp20 == 0) && (D_80083CA0.unk_A90 != 0)) {
        RSPTask_Submit(&D_800846C0, &D_8008472C, 0);
    }
...
void DisplayThread_Main(UNUSED void* arg) {
    ...
    FrameConfig_Init(&D_8008474C, 0, 1, 2, 0xFF, 0, 0, 0);
    FrameConfig_Init(&D_8008473C, 0, 1, 2, 0xFF, 0, 0, 0);
    SchedClient_Init(&D_80083CA0.thread, 0, 4);
    Sched_RegisterClient(&D_80083CA0);
    RSPTask_Init(&D_800846C0);
    while (1) {
        void* sp4C;
...
void Display_Init(void) {
    ...
    osCreateThread(&D_80083CA0.thread, 5, DisplayThread_Main, NULL, &D_80084680, 0x28);
    ...
    D_80083CA0.unk_A8A = 0;
    D_80084680[0] = ColorBuffer_Alloc(0, IMAGE_SIZE_BITS_16b, 0x280, 1, MEMORY_POOL_RIGHT);
...
void VI_RestoreMode(void) {
    VI_SetMode((s8)D_80083CA0.unk_AAD, (s8)D_80083CA0.unk_AAE);
}
